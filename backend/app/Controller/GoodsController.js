...
const TypeGoodsModel = use("App/Models/TypeGoods")
const Auth = use("Auth")
...
class GoodsController extends BaseController {
    constructor() {
        ...
        this.TypeGoodsModel = new TypeGoodsModel()
    }
    ...
    async getTypeGoods({ request, response }) {
        let allowFields = {
            _id: 1,
            name: 1,
            value: 1,
        ...
        let result = await this.TypeGoodsModel.aggregation([{
            $sort: {
                _id: -1
            }
        }]).getForGridTable(request.query, allowFields)
