...
class AreaController extends BaseController {
  ...
  async store({ request, response }) {
    ...
    if (existCode || existName) throw new ApiException(400, "Area_Code_Exist")
  ...
  async update({ request, response }) {
    ...
    if (exist.code == "All") {
      throw new ApiException(400, "Area_Update_Warning")
    }
    ...
    if (check) {
      ...
      throw new ApiException(400, "Area_Code_Exist")
    }
    return result
  }
  ...
  async delete({ request, response }) {
    ...
    for (let i of id) {
      ...
      if (!exist) throw new ApiException(404, "No_Object")
      if (exist.code == "All") {
        throw new ApiException(400, "Area_Del_Warning")
      }
    }
    id = []
